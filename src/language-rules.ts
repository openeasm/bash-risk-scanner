...
export const PYTHON_RULES: LanguageRule[] = [
  ...
  call({ id: "python.system-modification", category: "system_modification", title: "Modifies sensitive system configuration", severity: "critical", confidence: "high", message: "Writes sensitive system, network, firewall, proxy, or certificate configuration.", pattern: /(?:open|Path|write_text|write_bytes|shutil\.(?:copy|move))[\s\S]*(?:\/etc\/|sudoers|resolv\.conf|iptables|nftables|certificates?|proxy)/i }),
