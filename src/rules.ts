...
export const COMMAND_RULES: Rule[] = [
  ...
  {
    id: "destructive.sysrq-reboot",
    category: "destructive_behavior",
    title: "Forces an immediate kernel reboot",
    severity: "critical",
    confidence: "high",
    message: "Writes the immediate-reboot command to the Linux SysRq trigger without syncing filesystems.",
    pattern: /^\s*(?:echo(?:\s+-n)?\s+["']?b["']?|printf\s+(?:["']?b(?:\\n)?["']?|["']?%s(?:\\n)?["']?\s+["']?b["']?))\s*>\s*["']?\/proc\/sysrq-trigger["']?\s*$/i,
  },
  {
    id: "destructive.sysrq-crash",
    category: "destructive_behavior",
    title: "Forces an immediate kernel crash",
    severity: "critical",
    confidence: "high",
    message: "Writes the crash command to the Linux SysRq trigger.",
    pattern: /^\s*(?:echo(?:\s+-n)?\s+["']?c["']?|printf\s+(?:["']?c(?:\\n)?["']?|["']?%s(?:\\n)?["']?\s+["']?c["']?))\s*>\s*["']?\/proc\/sysrq-trigger["']?\s*$/i,
  },
  {
    id: "destructive.sysrq-poweroff",
    category: "destructive_behavior",
    title: "Forces an immediate kernel power-off",
    severity: "critical",
    confidence: "high",
    message: "Writes the power-off command to the Linux SysRq trigger without syncing filesystems.",
    pattern: /^\s*(?:echo(?:\s+-n)?\s+["']?o["']?|printf\s+(?:["']?o(?:\\n)?["']?|["']?%s(?:\\n)?["']?\s+["']?o["']?))\s*>\s*["']?\/proc\/sysrq-trigger["']?\s*$/i,
  },
  {
