...
Atomic Red Team DNS 外传、timestomp、`.netrc`、crontab、SUID、UFW、GCS 删除与
变量 Python 步骤已转为 validation 回归；冻结 test 分层当前使用 T1555.001
Keychain dump 步骤。本轮不针对新 test 调参，报告会如实保留 FP、FN 及 finding
约束错误。
