...
publish、Rustup installer、semantic-release/github、Bun installer 与 AWS CLI
GameLift uploader 的完整许可快照。冻结 test 分层当前使用 Deno installer 和
Oh My Zsh installer；本轮不针对新 test 调参，报告会如实保留 FP/FN。
