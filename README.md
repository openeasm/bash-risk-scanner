...
Atomic Red Team DNS 外传、timestomp、`.netrc`、crontab、SUID、UFW 与 GCS 删除
步骤已转为 validation 回归；冻结 test 分层当前使用 T1059.006 通过变量解析的
Python `-c` 步骤。本轮不针对新 test 调参，报告会如实保留 FP、FN 及 finding
约束错误。
