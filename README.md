...
publish、Rustup installer、semantic-release/github、Bun、AWS CLI、Deno 与
Oh My Zsh installer 的完整许可快照。冻结 test 分层当前使用 Hugging Face Hub
downloader 和 node-pre-gyp installer；本轮不针对新 test 调参，报告会如实保留
FP/FN。
