...
变量 Python、Keychain、T1543.001 emond 持久化与 T1048.003 Python HTTP server
步骤已转为 validation 回归；冻结 test 分层当前使用 T1686 `iptables -F` 防火墙
清空步骤。本轮不针对新 test 调参，报告会如实保留 FP、FN 及 finding 约束错误。
